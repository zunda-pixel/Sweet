...
extension Sweet {
  public func lookUpTweets(by ids: [String], tweetFields: [TweetField] = [], mediaFields: [MediaField] = [], pollFields: [PollField] = []) async throws -> [TweetModel] {
  ...
  public func lookUpTweet(by id: String, tweetFields: [TweetField] = [], mediaFields: [MediaField] = [], pollFields: [PollField] = []) async throws -> TweetModel {
