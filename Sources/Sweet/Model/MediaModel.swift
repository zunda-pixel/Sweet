...
extension Sweet {
  ...
  public struct MediaModel: Hashable, Identifiable, Sendable {
    ...
    public init(key: String, type: MediaType, size: CGSize, previewImageURL: URL? = nil, url: URL? = nil, variants: [MediaVariant] = [], durationMicroSeconds: Int? = nil, alternateText: String? = nil, metrics: MediaPublicMetrics? = nil, privateMetrics: MediaPrivateMetrics? = nil, promotedMetrics: MediaPromotedMetrics? = nil, organicMetrics: MediaOrganicMetrics? = nil) {
      self.key = key
      self.type = type
      self.size = size
...
extension Sweet.MediaModel: Codable {
  public init(from decoder: Decoder) throws {
    ...
    self.promotedMetrics = try? value.decode(Sweet.MediaPromotedMetrics.self, forKey: .promotedMetrics)
